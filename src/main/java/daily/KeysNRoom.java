...
public class KeysNRoom {
	 ...
	 * Example 1:
	 * 
	 * Input: rooms = [[1],[2],[3],[]] Output: true Explanation: We visit room 0 and
	 ...
	 * Example 2:
	 * 
	 * Input: rooms = [[1,3],[3,0,1],[2],[0]] Output: false Explanation: We can not
	 * enter room number 2 since the only key that unlocks it is in that room.
	 * 
	 * @param rooms - Given an array rooms where rooms[i] is the set of keys that
	 *              you can obtain if you visited room i
	 * @return - return true if you can visit all the rooms, or false otherwise.
	 */
