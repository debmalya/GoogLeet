...
public class DivisibleByP {
  /**
   * @param nums - Given an array of positive integers nums, remove the smallest subarray (possibly
   *     empty) such that the sum of the remaining elements is divisible by p. It is not allowed to
   *     remove the whole array.
   * @param p divisible by p.
