...
public class CountofSubstringsContainingEveryVowelandKConsonants3306 {
  /**
   * @param word - You are given a string .
   * @return Return the total number of substrings of word that contain every vowel ('a', 'e', 'i',
